      ...
      <div className="relative h-full overflow-y-auto rounded-none xl:rounded-3xl bg-white text-black xl:shadow-xl xl:ring ring-black/10">
        ...
        <div className="h-[calc(100%-11rem)] sm:h-[calc(100%-14rem)]">
          <div className="p-4 sm:p-5">
            ...
            <div className="text-sm mt-0.5 opacity-70 flex items-center gap-1">
            ...
            <div className="text-sm mt-5">
              {place.description} Join us in making a difference in the community.
              ...
              {[
                {
                  ...
                  text: "A great way to give back to the community. The organization is very well run!",
                },
                {
                  user: "Priya S.",
                  avatar: "https://persistent.oaistatic.com/pizzaz/user2.png",
                  text: "Friendly environment and very rewarding work. Met some wonderful people here.",
                },
                {
                  user: "Maya R.",
                  avatar: "https://persistent.oaistatic.com/pizzaz/user3.png",
                  text: "Perfect for weekend volunteering. They really value your contribution.",
                },
              ].map((review, idx) => (
